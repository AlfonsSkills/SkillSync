...
You don't need to explicitly tell the agent to use a skillâ€”it decides based on context. However, you can mention a skill by name if you want to ensure it's used.
