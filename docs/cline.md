...
- **Workflows**: Explicit sequences you invoke for specific tasks (like `/release.md` for a release process).
- **Skills**: Expertise that Cline activates automatically when relevant (like data analysis knowledge when you're working with CSV files).
